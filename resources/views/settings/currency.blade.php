    ...
    <x-core::custom-template id="currency_template">
        ...
        <li data-id="__id__" class="clearfix">
            ...
            <div class="swatch-item swatch-exchange-rate" data-type="exchange_rate">
                <input type="number" @disabled(get_currency_setting('use_exchange_rate_from_api')) class="form-control input-exchange-rate" value="__exchangeRate__" step="0.00000001">
            </div>
            <div class="swatch-item swatch-is-prefix-symbol" data-type="is_prefix_symbol">
                <select class="form-select">
                    <option value="1" __isPrefixSymbolChecked__>{{ trans('plugins/currency::currency.before_number') }}</option>
                    <option value="0" __notIsPrefixSymbolChecked__>{{ trans('plugins/currency::currency.after_number') }}</option>
                </select>
            </div>
