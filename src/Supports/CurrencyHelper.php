...
namespace Botble\Currency\Supports;

use Botble\Base\Supports\Language;
use Botble\Currency\Models\Currency;
use Botble\Currency\Services\ExchangeRates\ExchangeRateInterface;
...
class CurrencyHelper
{
    ...
    {
        if (
            ! get_currency_setting('use_exchange_rate_from_api') ||
            ! get_currency_setting('exchange_rate_api_provider') ||
            (! get_currency_setting('api_layer_api_key') && ! get_currency_setting('open_exchange_app_id'))
        ) {
            return $currency;
        }
    ...
    {
        return config('plugins.currency.general.prefix');
    }
