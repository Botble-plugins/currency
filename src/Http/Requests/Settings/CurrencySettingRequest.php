...
namespace Botble\Currency\Http\Requests\Settings;
...
class CurrencySettingRequest extends Request
{
    ...
    public function rules(): array
    {
        return [
            ...
            'currencies_data.*.title' => ['required', 'string', Rule::in(CurrencyHelper::currencyCodes())],
    ...
    {
        return [
            'currencies_data.*.title.in' => trans('plugins/currency::currency.invalid_currency_name', [
    ...
    {
        return [
            'currencies_data.*.title' => trans('plugins/currency::currency.invalid_currency_name'),
            'currencies_data.*.symbol' => trans('plugins/currency::currency.symbol'),
        ];
    }
}
